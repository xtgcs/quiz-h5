    ...
    <Dialog :value="show__rule">
      <div class="modal__box">
        <div>
          ...
          <input class="phone__number__input" placeholder="请输入手机号" type="number">
        </div>
...
export default {
  ...
  methods: {
		confirmProject() {
			// confirm("focus/save", "POST", {"focus_id": parseInt(this.focus_id), "mobile": this.mobile_num, "option_number": })
		},
    initPage() {
